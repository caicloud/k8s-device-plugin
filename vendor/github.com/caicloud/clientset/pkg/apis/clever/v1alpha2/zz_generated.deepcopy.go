...
func (in *MLNeuronConfig) DeepCopyInto(out *MLNeuronConfig) {
	*out = *in
	in.TensorFlowConf.DeepCopyInto(&out.TensorFlowConf)
	in.PyTorchConf.DeepCopyInto(&out.PyTorchConf)
	in.SparkConf.DeepCopyInto(&out.SparkConf)
	in.JupyterConf.DeepCopyInto(&out.JupyterConf)
	return
}
